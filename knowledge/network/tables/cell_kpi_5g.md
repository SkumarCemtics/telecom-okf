---
description: Cell-level NR (5G) network performance KPI dataset used for accessibility, retainability, throughput, capacity, mobility, and radio quality analysis.
...
Contains cell-level 5G NR performance measurements used to evaluate network accessibility, session stability, user experience, throughput, capacity utilization, mobility performance, and radio conditions.
...
| cell_name | text | Unique 5G cell identifier |
| frequency | integer | Operating carrier frequency |
| bandwidth | text | Allocated 5G bandwidth |
